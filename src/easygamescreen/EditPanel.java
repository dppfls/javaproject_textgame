...
public class EditPanel extends JPanel {
	private ImageIcon normalChar = new ImageIcon("resource/img/char_normal.jpg");// 기본 표정
	private ImageIcon heartChar = new ImageIcon("resource/img/char_heart.jpg");// 하트 표정
	private ImageIcon cryChar = new ImageIcon("resource/img/char_cry.jpg");// 우는 표정
	private ImageIcon angryChar = new ImageIcon("resource/img/char_angry.jpg");// 화난 표정
	private ImageIcon surpriseChar = new ImageIcon("resource/img/char_surprise.jpg");// 놀란 표정
	...
	public void setCharImage(Graphics g, Dimension d, boolean isCorrectAnswer) {
		if (isCorrectAnswer) {
			...
			// 답이 틀렸을 때
			// 랜덤으로 char_cry, angry, surprise 중 하나를 선택하여 설정해서 보여준다
	...
	public EditPanel() {
		...
		textLabel.setBounds(52, 153, 109, 37);
		add(textLabel);
	}
